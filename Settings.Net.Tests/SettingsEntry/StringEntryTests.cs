...
namespace Settings.Net.Tests.SettingsEntry {
    ...
    public class StringEntryTests {
        [TestCase("StringEntry1", "Value1", "Description1"), TestCase("StringEntry2", "Value2", null),
        ...
        [TestCase("Invalid.Name", "some value"), TestCase("Another Invalid Name", "some value")]
        ...
        [TestCase(StringEntryJsonSource.InvalidIdEntry1), TestCase(StringEntryJsonSource.InvalidIdEntry2)]
        ...
        [TestCase(StringEntryJsonSource.InvalidType_IntType), TestCase(StringEntryJsonSource.InvalidType_BoolType)]
        ...
        [TestCase(StringEntryJsonSource.MissingTypeKey), TestCase(StringEntryJsonSource.MissingValueKey)]
        ...
        private static class StringEntryJsonSource {
            ...
            public const string MissingValueKey =
                @"{'MissingValueKey':{'type':'Settings.StringEntry','desc':'A string entry with int value.'}}";
        }
    }
}